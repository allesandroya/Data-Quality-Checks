...
#         return out_date_count, out_date_errors
    ...
    def run_checks(self):
        ...
        first_df = pd.read_csv(first_filepath, encoding= 'unicode_escape', dtype = {0:str}, keep_default_na=False, na_values=[''], low_memory=False)
